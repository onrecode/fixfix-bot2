...
- **Автоматические runner'ы** - GitHub предоставляет runner'ы для выполнения workflow'ов
...
Для автоматизации сборки и развертывания мы используем GitHub Actions - современную и простую в настройке систему CI/CD.

#### Преимущества:
- **Простота**: Не требует настройки собственных runner'ов
- **Надежность**: GitHub предоставляет стабильные runner'ы
- **Гибкость**: Готовые action'ы для всех задач
...
1. **Создание репозитория на GitHub**:
   ...
   - Скопируйте код из GitLab

2. **Настройка секретов**:
   - В Settings > Secrets and variables > Actions добавьте:
     - `PROD_HOST` - IP вашего сервера
     - `PROD_USERNAME` - имя пользователя для SSH
     - `PROD_SSH_KEY` - приватный SSH ключ

3. **Workflow'ы автоматически запускаются**:
   - При push в main ветку
   - При создании Pull Request

Подробные инструкции см. в [GITHUB_ACTIONS_SETUP.md](GITHUB_ACTIONS_SETUP.md)

### Автоматическое развертывание

После настройки GitHub Actions workflow автоматически:
- Тестирует код
...
 # #   >���  "5AB  G i t H u b   A c t i o n s  
 -B>B  @0745;  4>102;5=  4;O  B5AB8@>20=8O  G i t H u b   A c t i o n s   w o r k f l o w .  
 C I / C D   P i p e l i n e  
 A=>2=>9  P i p e l i n e   4;O  02B><0B8G5A:>3>  45?;>O  =0  A5@25@ 
 